...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="mt-5">
                <h5 class="text-gray-600 uppercase font-bold">Add Student</h5>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('student.index') }}" class="text-white text-sm uppercase py-2 px-4 flex items-center rounded" style="background-color:#DAA520;text-decoration: none;">
        ...
        <div class="container mt-8">
            <form action="{{ route('student.store') }}" method="POST" class="w-full max-w-xl px-6 py-12" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="roll_number" name="roll_number" type="number" class="form-control @error('roll_number') is-invalid @enderror" value="{{ old('roll_number') }}">
                        @error('roll_number')
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-md-6">
                        <input id="permanent_address" name="permanent_address" type="text" class="form-control @error('permanent_address') is-invalid @enderror" value="{{ old('permanent_address') }}">
                ...
                <div class="form-group row mt-3">
                    <label for="password" class="col-md-3 col-form-label text-md-right text-gray-600">Password</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row mt-3">
                    <label for="dateofbirth" class="col-md-3 col-form-label text-md-right text-gray-600" style="color: gray;">Date of Birth</label>
                    <div class="col-md-6">
